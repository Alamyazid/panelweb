...
Route::get('/dashboard', function () {
    $totalDeposite = Invoice::where(['user_id' => Auth()->user()->id, 'status' => 'PAID'])->sum('amount');
    return view('dashboard', compact('totalDeposite'));
})->middleware(['auth', 'verified', 'role:customer|reseller'])->name('dashboard');
