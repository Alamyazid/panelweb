    ...
    $data = '<div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-12 mb-3 d-grid gap-2">
                    <a href="/accounts/ssh/'. $createssh['data']['User'] .'" class="btn btn-primary btn-sm" id="details">
            ...
            <div class="col-sm-12">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th class="align-middle">Protocol:</th>
                            <td class="align-middle">'. $createssh['data']['Vmess'] .'</td>
                        </tr>
                        <tr>
                            <th class="align-middle">Port TLS:</th>
                            <td class="align-middle">'. $createssh['data']['PortTLS'] .'</td>
                ...
                <div class="col-12 mb-3 d-grid gap-2">
                    <a href="/accounts/vmess/'. $createssh['data']['User'] .'" class="btn btn-primary btn-sm" id="details">
                        <span id="btnText">Details Account</span>
                    </a>
                </div>
                <p class="text-muted mt-3" style="font-size:x-small">
            ...
            <div class="col-sm-12">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th class="align-middle">Protocol:</th>
                            <td class="align-middle">'. $createssh['data']['Vless'] .'</td>
                        </tr>
                        <tr>
                            <th class="align-middle">Port TLS:</th>
                            <td class="align-middle">'. $createssh['data']['PortTLS'] .'</td>
                ...
                <div class="col-12 mb-3 d-grid gap-2">
                    <a href="/accounts/vless/'. $createssh['data']['User'] .'" class="btn btn-primary btn-sm" id="details">
                        <span id="btnText">Details Account</span>
                    </a>
                </div>
                <p class="text-muted mt-3" style="font-size:x-small">
            ...
            <div class="col-sm-12">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th class="align-middle">Protocol:</th>
                            <td class="align-middle">'. $createssh['data']['Shadowsocks'] .'</td>
                        </tr>
                        <tr>
                            <th class="align-middle">Port TLS:</th>
                            <td class="align-middle">'. $createssh['data']['PortTLS'] .'</td>
                ...
                <div class="col-12 mb-3 d-grid gap-2">
                    <a href="/accounts/shadowsocks/'. $createssh['data']['User'] .'" class="btn btn-primary btn-sm" id="details">
                        <span id="btnText">Details Account</span>
                    </a>
                </div>
                <p class="text-muted mt-3" style="font-size:x-small">
