...
class AccountService
{
    ...
    private function buySSHAccount($server, $request)
    {
        ...
        $this->url = "http://" . $server->host . ":14022/api/ssh";
        $this->body = [
            "host" => $server->host,
    ...
    private function buyVmessAccount($server, $request)
    {
        ...
        $this->headers['X-API-KEY'] = $server->token;
        $this->url = "http://" . $server->host . ":14022/api/vmess";
        $this->body = [
            "host" => $server->host,
            "username" => Str::lower($username),
            "sni" => $request->sni,
    ...
    private function buyVlessAccount($server, $request)
    {
        ...
        $this->headers['X-API-KEY'] = $server->token;
        $this->url = "http://" . $server->host . ":14022/api/vless";
        $this->body = [
            "host" => $server->host,
            "username" => Str::lower($username),
            "sni" => $request->sni,
    ...
    private function buyTrojanAccount($server, $request)
    {
        ...
        $this->headers['X-API-KEY'] = $server->token;
        $this->url = "http://" . $server->host . ":14022/api/trojan";
        $this->body = [
            "host" => $server->host,
            "username" => Str::lower($username),
            "sni" => $request->sni,
    ...
    private function trialSSHAccount($server, $request)
    {
        ...
        $this->headers['X-API-KEY'] = $server->token;
        $this->url = "http://" . $server->host . ":14022/api/sshtrial";
        $this->body = [
            "host" => $server->host,
            "username" => Str::lower($username),
            "password" => Str::lower($password),
    ...
    private function trialVmessAccount($server, $request)
    {
        ...
        $this->headers['X-API-KEY'] = $server->token;
        $this->url = "http://" . $server->host . ":14022/api/vmesstrial";
        $this->body = [
            "host" => $server->host,
            "username" => Str::lower($username),
            "sni" => $request->sni,
    ...
    private function trialVlessAccount($server, $request)
    {
        ...
        $this->headers['X-API-KEY'] = $server->token;
        $this->url = "http://" . $server->host . ":14022/api/vlesstrial";
        $this->body = [
            "host" => $server->host,
            "username" => Str::lower($username),
            "sni" => $request->sni,
    ...
    private function trialTrojanAccount($server, $request)
    {
        ...
        $this->headers['X-API-KEY'] = $server->token;
        $this->url = "http://" . $server->host . ":14022/api/trojantrial";
        $this->body = [
            "host" => $server->host,
            "username" => Str::lower($username),
            "sni" => $request->sni,
